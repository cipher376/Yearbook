(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["public-login-login-module"], {
    ...
    function srcAppPublicLoginLoginPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _shared_services_providers_storage_my_storage_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      ...
      var src_app_shared_services_providers_navigation_browser_history_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      ...
      var LoginPage = /*#__PURE__*/function () {
        ...
        // _socialToken: any;
        function LoginPage(router, route, userService, fb, store, menu, toaster, util, loadCtrl, // private platform: Platform,
        alertCtrl, // private _browser: InAppBrowser,
        browserHistory) {
          var _this = this;
          ...
          this.isShow = false; // this.fb.logout().then(_ => {
          //   console.log(_);
          // });
          ...
          this.store.getObject('user').then(function (user) {
            _this.user = user;
        ...
        _createClass(LoginPage, [{
          ...
          value: function ngOnInit() {
            ...
            this.loginForm = this.fb.group({
              email: ['fslinn0@xinhuanet.com', [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].email, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].minLength(6), _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].maxLength(30)]],
              password: ['T775Vp15P', [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].minLength(5), _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].maxLength(20)]],
              remember: [false]
              ...
              return regeneratorRuntime.wrap(function _callee$(_context) {
                while (1) {
                  switch (_context.prev = _context.next) {
                    ...
                    case 9:
                      _context.next = 11;
                      return this.userService.login(this.loginForm.value).subscribe(function (res) {
                        if (res) {
                          // fetch user details
                          _this2.userService.getMyProfile().subscribe(function (user) {
                            var _a;

                            _this2.user = user;
                            console.log(_this2.user);

                            if ((_a = _this2.user) === null || _a === void 0 ? void 0 : _a.phone) {
                              _this2.router.navigateByUrl('/links/home');
                            } else {
                              _this2.router.navigateByUrl('/phone-number');
                            }
                          });
                        }

                        _this2._loading.dismiss();
                      }, function (error) {
                        console.log(error);

                        _this2.toaster.toast(error.message, 4000);

                        _this2._loading.dismiss(); // if (error.search('verified') > -1) {
